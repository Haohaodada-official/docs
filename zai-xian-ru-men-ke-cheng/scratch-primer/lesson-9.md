...
2. ![](../../.gitbook/assets/scratch9-2.png) 

属于“画笔”类别指令，作用与上一个指令正好相反，角色在舞台上移动时不会留下画笔轨迹，默认状态下，所有角色都处于这种状态。



3. ![](../../.gitbook/assets/scratch9-3.png) 

属于“画笔”类别指令，清除舞台中所有的画笔轨迹e。



4. ![](../../.gitbook/assets/scratch9-4.png) 
...
5. ![](../../.gitbook/assets/scratch9-5.png) 

属于“画笔”类别指令，将画笔设置成指定粗细；指令的参数就是具体的粗细值。



6. ![](../../.gitbook/assets/scratch9-6.png) 

属于“事件”类别指令，当按下键盘上的指定按键时，执行指令下方的脚本；可以在下拉列表参数中选择具体的按键。



7. ![](../../.gitbook/assets/scratch9-7.png) 
...
8. ![](../../.gitbook/assets/scratch9-8.png) 

属于“控制”类别指令，Scratch“循环”程序结构的一种，可以无条件地重复执行指令所包含的脚本。



9. ![](../../.gitbook/assets/scratch9-9.png) 

属于“动作”类别指令，当鼠标位于舞台范围内时，可以将角色定位到鼠标指针位置。



10. ![](../../.gitbook/assets/scratch9-10.png) 

属于“侦测”类别指令，检测是否按下了鼠标左键。



11. ![](../../.gitbook/assets/scratch9-11.png)、![](../../.gitbook/assets/scratch9-12.png) 
...
3. 单击“角色列表区”的 ![](../../.gitbook/assets/scratch5-6.png) 按钮，进入“造型”选项卡后，单击右下角的 ![](../../.gitbook/assets/scratch8-7.png) 按钮，进入“矢量模式”。


4. 单击选中“矢量工具按钮”中的 ![](../../.gitbook/assets/scratch9-13.png) 按钮，再单击选中“颜色”区域的 ![](../../.gitbook/assets/scratch8-9.png) 、“填充模式”中的 ![](../../.gitbook/assets/scratch8-10.png) ，最后在“造型编辑区”拖动鼠标，画出一个红色矩形；将这个新角色命名为“红色”。
 ...
 * 上述脚本中的 ![](../../.gitbook/assets/scratch9-8.png) 指令能否删除？为什么？
